...
// Request is the Postgres based implementation of the FileManager interface Request function.
func (manager *Manager) Request(callReference string) (entry *gosharexserver.FileEntry, err error) {
	panic("not implemented")
}

// Delete is the Postgres based implementation of the FileManager interface Delete function.
